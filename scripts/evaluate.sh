...
DATA_ROOT="${DATA_ROOT:-/home/hoangnv/AICD_HA/SPINE/dataset/SPIDER/output_fused_256}"
VAL_CSV="${VAL_CSV:-/home/hoangnv/AICD_HA/SPINE/dataset/SPIDER/kfold_splits/S1_composite_grok/fold_3_image/test.csv}"
