...
DATA_ROOT="${DATA_ROOT:-/home/hoangnv/AICD_HA/dataset/Lumbar/dataset_lumbar_256}"
VAL_CSV="${VAL_CSV:-/home/hoangnv/AICD_HA/dataset/Lumbar/dataset_lumbar_256/report/test.csv}"
