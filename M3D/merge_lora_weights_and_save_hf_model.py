...
class ModelArguments:
    ...
    model_name_or_path: Optional[str] = field(
        ...
        metadata={
            "help": "Path to the LLM or MLLM. microsoft/Phi-3-mini-4k-instruct, llama-2-7b-chat"
        },
    )
    model_type: Optional[str] = field(default=None, metadata={"help": "llama2, phi3"})

    model_with_lora: Optional[str] = field(
        default="./output_spine_dual_v1/model_with_lora.bin",
    ...
    # segvol
    segmentation_module: str = field(default=None, metadata={"help": "segvol or None"})
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = "./output_spine_dual_v1/merged_hf/"
...
def main():
    ...
    print(f"Saving merged_model.bin to: {training_args.output_dir}")
